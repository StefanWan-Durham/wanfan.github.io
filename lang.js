...
const translations = {
  ...
  module_paper_snapshot_desc: '复杂论文，一页终结。用最精炼的摘要和图示解读核心思想。',
  module_paper_snapshot_title: '一页论文',
  module_paper_snapshot_name: '🧾 一页论文 · Paper Snapshot · Resumen de Artículos',
  ...
  ai_lab_news_desc: 'Daily AI read: ScholarPush, News Radar, Paper Snapshot, and Release Tracker.',
  ...
  module_scholarpush_name: '🧠 学术快报 · ScholarPush · ImpulsoAcadémico',
  module_paper_snapshot_desc: 'Complex papers, distilled to one page—clear summaries and visuals that reveal the core ideas.',
  module_paper_snapshot_title: 'Paper Snapshot',
  module_paper_snapshot_name: '🧾 一页论文 · Paper Snapshot · Resumen de Artículos',
  ...
  ai_lab_news_desc: 'Lectura diaria: ScholarPush, Radar de noticias, Resumen de artículos y seguimiento de lanzamientos.',
  ...
  module_scholarpush_name: '🧠 学术快报 · ScholarPush · ImpulsoAcadémico',
  module_paper_snapshot_desc: 'Papers complejos en una sola página: resúmenes claros e imágenes que explican la idea central.',
  module_paper_snapshot_title: 'Resumen de Artículos',
  module_paper_snapshot_name: '🧾 一页论文 · Paper Snapshot · Resumen de Artículos',
