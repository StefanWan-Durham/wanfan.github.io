...
const translations = {
  ...
  hero_btn_cv: '下载简历',
    ...
    about_p2: '我的研究聚焦于大语言模型在核工业实际场景中的应用。同时热衷于机器学习、计算机视觉、多媒体分析，以及基于大模型的智能体和下游任务开发。',
    // Research summary
  ...
  footer_cta_desc: '我可提供 LLM 应用、计算机视觉与多媒体分析相关的咨询与合作。',
    // Biography page
    bio_title: '个人简介',
    bio_p1: '我于2018年获得英国纽卡斯尔大学计算机科学硕士学位（荣誉），并于2025年1月在英国杜伦大学完成计算机科学博士学位。在博士研究期间，我专注于计算机视觉与多模态算法，并积极探索大语言模型及其在实际问题中的应用。',
    bio_p2: '目前，我在中国核工业集团同方知网数字技术有限公司担任研究员，致力于将大语言模型应用于核工业场景。我对机器学习、联邦学习、计算机视觉、多媒体分析和 AIGC 技术充满热情，并参与多项跨学科合作。',
